...
link:http://grafana.org/[Grafana] provides an API key which gives access for 3rd party application like _{product-title}_.
The _Grafana Dashboard Box_ on the start page shows dashboards related to _{product-title}_.
...
.Quick access to Grafana dashboards from the {product-title} start page
image::01_grafana-box.png[]
