...
If the Identify command is successful, the service is marked as detected and the product details returned by the command are optionally stored in the asset fields.
...
.Parameters for the WsManDetector
