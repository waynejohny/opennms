...
Like many of the daemon configuration in the 1.7 branch, the configurations are reloadable without having to restart {product-title}, using the reloadDaemonConfig uei:
